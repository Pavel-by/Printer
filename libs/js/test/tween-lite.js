...
(function (t, e) {
    ...
    if (!i.TweenLite) {
        ...
        v("Ticker", function (t, e) {
            var i, s, n, r, l, h = this, u = S(), m = e !== !1 && k, p = 500, c = 33,
                d = function (t) {
                    var e, a, o = S() - x;
        ...
        var O = [], L = {}, N = I._internals = {isArray: m, isSelector: E, lazyTweens: O},
            U = I._plugins = {}, F = N.tweenLookup = {}, j = 0, G = N.reservedProps = {
                ...
                "true": 1,
                "false": 0
            }, q = C._rootFramesTimeline = new D, B = C._rootTimeline = new D,
